...
st.sidebar.text("""Ce dispositif médical est encore en développement. Son utilisation, quelle qu'en soit sa nature, ne peut engager la responsabilité de ses créateurs.
